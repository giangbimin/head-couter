...
const SideBar = () => {
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-between pt-4 pr-4 pl-7">
          <svg
          ...
          <div className="lg:hidden">
            <button
              ...
              className="w-8 h-8 inline-flex justify-center items-center gap-2 rounded-md text-gray-700 align-middle focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all dark:text-gray-400 dark:focus:ring-offset-gray-800"
        ...
        <div className="h-full">
          <ul className="space-y-1.5 p-4">
            <li>
              <Link
                className="flex items-center gap-x-3 py-2 px-3 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300"
                href="/"
              >
                <svg
        ...
        <div className="mt-auto">
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700">
            <Link
              className="flex justify-between items-center gap-x-3 py-2 px-3 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300"
              href="/"
            >
              Sign in
              <svg
